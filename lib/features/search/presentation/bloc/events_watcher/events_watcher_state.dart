...
class EventsWatcherState with _$EventsWatcherState {
  ...
  const factory EventsWatcherState.loadSuccess(List<Event> events) = _LoadSuccess;
  const factory EventsWatcherState.loadFailure(EventFailure failure) = _LoadFailure;
}
